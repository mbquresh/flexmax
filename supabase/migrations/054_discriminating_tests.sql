  ...
  select jsonb_build_object(
    ...
    'data_quality', jsonb_build_object(
      ...
      'caveats', jsonb_build_array(
        ...
        'quality_drift describes the BLOCK''s trajectory, never the user''s effort. Ratings are Excellent / Partly / Poor (storage keys crushed / partial / pulled_away — never speak the storage keys). Say "landing at half strength", never "you have not been focused".',
